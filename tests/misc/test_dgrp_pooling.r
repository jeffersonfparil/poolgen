...
dat = dat[dat$Line != "RAL_514", ]
dat = dat[dat$Line != "RAL_365", ]
dat = dat[dat$Line != "RAL_387", ]
dat = dat[dat$Line != "RAL_554", ]
dat = dat[dat$Line != "RAL_771", ]
dat = dat[dat$Line != "RAL_750", ]
dat = dat[dat$Line != "RAL_375", ]
dat = dat[dat$Line != "RAL_380", ]
dat = dat[dat$Line != "RAL_391", ]
dat = dat[dat$Line != "RAL_738", ]
dat = dat[dat$Line != "RAL_805", ]
dat = dat[dat$Line != "RAL_287", ]
dat = dat[dat$Line != "RAL_882", ]
dat = dat[dat$Line != "RAL_358", ]
dat = dat[dat$Line != "RAL_393", ]
dat = dat[dat$Line != "RAL_853", ]
dat = dat[dat$Line != "RAL_176", ]
dat = dat[dat$Line != "RAL_217", ]
